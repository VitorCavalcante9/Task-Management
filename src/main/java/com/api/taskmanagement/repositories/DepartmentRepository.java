...
public interface DepartmentRepository extends JpaRepository<Department, Long> {
  ...
  @Query("SELECT new com.api.taskmanagement.dtos.ListDepartmentDto(d.id, d.title, count(distinct p.id), count(distinct t.id)) FROM Department d JOIN d.tasks t JOIN d.people p GROUP BY d.id")
